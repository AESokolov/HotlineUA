	...
	public void test() {
		...
		WebElement enterCity = driver.findElement(By.xpath("/html/body/header/div[1]/div/div/div[1]/div/div[2]/div/div[2]/div/div[2]/span[1]")); 
 		...
 		WebElement enterEnter = driver.findElement(By.xpath("//*[@id=\"page-index\"]/header/div[1]/div/div/div[2]/div[4]"));
  		...
  		WebElement registration = driver.findElement(By.xpath("/html/body/div[1]/div[1]/div/div[1]/div/p/a"));
  		registration.click();
  		
  		WebElement email = driver.findElement(By.name("email"));
  		email.sendKeys("sigizmundok@i.ua");
  		
  	WebElement nick = driver.findElement(By.name("login"));
  		nick.sendKeys("falcon345");	
  		
  	WebElement checkbox = driver.findElement(By.xpath("//*[@id=\"reg-form\"]/div/div/div[4]/label"));
    	checkbox.click();
    	
    	WebElement password = driver.findElement(By.name("password"));
  		password.sendKeys("fqw12345SD");
  		
  		WebElement start = driver.findElement(By.id("submit-button"));  
 		start.click();
